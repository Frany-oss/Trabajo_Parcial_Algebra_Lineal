...
numeroPares = tk.Scale(UI_frame, from_=8, to=12, length=200, digits=1, resolution=1, orient=tk.HORIZONTAL, label="Numero de Pares")
numeroPares.grid(row=0, column=1, padx=5, pady=5)

# Escala para medir el grado polinomial que va desde 2 a 6
numeroGrado = tk.Scale(UI_frame, from_=2, to=6, length=200, digits=1, resolution=1, orient=tk.HORIZONTAL, label="Grado Polinomial")
...
tk.Button(UI_frame, text="Graficar", command=showPlots, bg='light green').grid(row=0, column=4, padx=10, pady=10)

# Boton para salir del programa
tk.Button(UI_frame, text="Salir", command=exit, bg='red').grid(row=0, column=6, padx=10, pady=10)
